  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div className="col-span-1 md:col-span-1">
        <h3 className="text-2xl font-bold text-white mb-4">PulseFlow Fitness Studio</h3>
        <p className="text-sm text-gray-400">
          Transform your body, elevate your mind, and discover your strength.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="/wellness" className="hover:text-white transition-colors">Wellness Programs</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2 mb-4">
          ...
          <li><a href="mailto:info@pulseflow.com" className="hover:text-white transition-colors">info@pulseflow.com</a></li>
        </ul>
    ...
    <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
      <p className="text-sm text-gray-400">
        &copy; {new Date().getFullYear()} PulseFlow Fitness Studio. All rights reserved.
      </p>
