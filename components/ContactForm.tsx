...
export default function ContactForm() {
  ...
  <div className="mb-8 text-center">
    <h2 className="text-3xl font-bold text-gray-900 mb-2">Contact PulseFlow Fitness Studio</h2>
    <p className="text-gray-600">Get in touch with us and start your fitness journey today</p>
  </div>
